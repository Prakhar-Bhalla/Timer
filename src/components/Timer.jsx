...
export const Timer = () => {
    ...
    return <div style={{margin : "20px 0"}}>{flag && <p style={{color : "red"}}>Time up!</p>}Counter : <input style={{width : "20px", textAlign : "center", outline : "none", border : "2px solid brown"}} readOnly="readOnly" value={clockSec}/>
